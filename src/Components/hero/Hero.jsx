  ...
  return (
    ...
    <div className="video">
      <video src={video} autoPlay muted loop className='w-100'></video>
       ...
       <p className='fs-5 text-secondary fw-normal'><span className='fw-bold  text-warning '><u>Modernization Theory:</u> </span>This theory posits that agricultural development is a key driver of overall economic growth and progress. <br />The modernization of agriculture—through new technologies, <br /> better tools, and education—can lead to increased productivity, higher incomes, and improved living standards for farmers.</p>
